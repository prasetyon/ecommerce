...
<body>
		...
		<ul class="nav menu">
			...
			<li class="parent">
				...
				<ul class="children collapse in" id="sub-item-1" aria-expanded="true">
                    ...
                    <li>
						<a class="active" href="view_picture.php">
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">			
		...
		<div class="row">
			<div class="col-lg-12">
				<h1 class="page-header">Lihat Gambar Produk</h1>
			</div>
		</div>
      ...
      <div class="col-md-12">
       ...
       echo'     <div class="row">
			<div class="col-lg-12">
				<h1 class="page-header">Lihat Gambar Produk ID: '.$id.'</h1>
			</div>
		</div>';
        $rows = mysql_query("select * from GAMBAR WHERE ID_PRODUK=$id"); // multiple rows
		while ($row = mysql_fetch_array($rows)) {
            $foto = $row['FOTO'];
            echo "
